...
public class Client {
    ...
    public Client(Integer idClient, String nom, String prenom, String mdp, String email, float budget, float offre, int demande, int idProduit, String nomProduit) {
    ...
    public static Integer rencherir() throws Exception{
        ...
        try {
            ...
            con = DBAConnection.connect();
            ps = con.prepareStatement("insert into enchereproduit(idclient,idproduit,offre, date, statut) values(?,?,?,?,?)");
